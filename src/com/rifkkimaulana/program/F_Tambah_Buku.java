 ...
 */
public class F_Tambah_Buku extends javax.swing.JFrame {
    

    /**
     * Creates new form F_Tambah_Buku
     */
    public F_Tambah_Buku() {
        initComponents();
    }

    F_Tambah_Buku(F_Data_Buku aThis, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Tambah_Buku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_Tambah_Buku().setVisible(true);
            }
        });
    }
